...
import torch, pdb
import numpy as np
from src.shared import download_model, EOS_token
...
class GPT2Generator:
    ...
    def __init__(self, path, cuda):
        ...
        self.model = AutoModelForCausalLM.from_pretrained(path + "friends4_epoch3_medium_pretrained")
        self.ix_EOS = 50256
        self.model.eval()
        self.cuda = cuda
        if self.cuda:
...
PATH = "/content/drive/MyDrive/01. Programming/2021 데청캠/프로젝트(기초)/Friends/"
DATA_PATH = "/content/drive/MyDrive/01. Programming/2021 데청캠/프로젝트(기초)/Friends/data/"
TRANSCRIPT_PATH = "/content/drive/MyDrive/01. Programming/2021 데청캠/프로젝트(기초)/Friends/data/프로젝트 대본/"
MODEL_PATH = "/content/drive/MyDrive/01. Programming/2021 데청캠/프로젝트(기초)/Friends/models/"
